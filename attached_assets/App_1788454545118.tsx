  ...
  return (
    <main className="min-h-screen bg-white text-[#02110c] antialiased">
      ...
      <section id="top" className="mx-auto w-full max-w-7xl px-5 pb-16 pt-6 md:px-10 md:pb-28 md:pt-16">
        ...
        <h1 className="serif mt-6 max-w-5xl text-[clamp(2.8rem,7.2vw,6.6rem)] font-normal leading-[.92] text-[#02110c]">
        ...
        <p className="mt-8 max-w-2xl text-[1.08rem] leading-[1.6] text-[#02110c]/78 md:text-[1.18rem]">
      ...
      <section className="bg-[#02110c] px-5 py-20 text-white md:px-10 md:py-32">
        <div ref={espelho.ref} style={espelho.style} className="mx-auto max-w-7xl">
          ...
          <h2 className="serif mt-4 max-w-4xl text-5xl leading-[.94] md:text-7xl">
            Com quem você fala <span className="text-[#06392f]">quando não dá pra falar com ninguém?</span>
          </h2>
      ...
      <section className="bg-[#02110c] px-5 py-20 text-white md:px-10 md:py-32">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="serif mt-4 max-w-3xl text-5xl leading-[.94] md:text-6xl">
            Não é um chat de robô. É gente <span className="text-[#06392f]">respondendo gente.</span>
          </h2>
      ...
      <section id="por-que" className="bg-[#02110c] px-5 py-20 text-white md:px-10 md:py-32">
        <div ref={encontra.ref} style={encontra.style} className="mx-auto max-w-7xl">
          ...
          <h2 className="serif mt-4 max-w-3xl text-5xl leading-[.94] md:text-7xl">
            Não é mais uma rede social. É <span className="text-[#06392f]">quase o oposto dela.</span>
          </h2>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[.9fr_1.1fr] md:items-center md:gap-20">
          <div ref={origem.ref} style={origem.style}>
            ...
            <h2 className="serif mt-4 text-5xl leading-[.93] md:text-7xl">
              Você não precisa segurar tudo <span className="text-[#06392f]">sozinho.</span>
            </h2>
